...
TEST_CASE("Test default values", "[Settings]") {
  solar_system::Settings settings;
...
TEST_CASE("Test language", "[Settings]") {
  ...
  QSignalSpy spy(&settings, &solar_system::Settings::languageChanged);
...
TEST_CASE("Test window opacity", "[Settings]") {
  ...
  QSignalSpy spy(&settings, &solar_system::Settings::windowOpacityChanged);
...
TEST_CASE("Test fps visible", "[Settings]") {
  ...
  QSignalSpy spy(&settings, &solar_system::Settings::fpsVisibleChanged);
...
TEST_CASE("Test quit shortcut", "[Settings]") {
  ...
  QSignalSpy spy(&settings, &solar_system::Settings::quitShortcutChanged);
...
TEST_CASE("Test options shortcut", "[Settings]") {
  ...
  QSignalSpy spy(&settings, &solar_system::Settings::optionsShortcutChanged);
...
TEST_CASE("Test full screen shortcut", "[Settings]") {
  ...
  QSignalSpy spy(&settings, &solar_system::Settings::fullScreenShortcutChanged);
